<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditAvailability.aspx.vb" Inherits="When_Where_Web_Application.EditAvailability" %>
<!DOCTYPE html>
            ...
            <tr><td>Ask All To Bring:</td> 
             ...
             <tr><td><br /><asp:LinkButton ID="btnOK" text="OK" runat="server" Width="69px" /></td> 
               <td><br /><asp:LinkButton ID="btnCancel" text="Cancel" runat="server" Width="72px" /></td>
                 <td><br /><asp:LinkButton ID="btnDelete" text="Delete this event" runat="server" Width="72px" /></td>
